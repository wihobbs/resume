...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science (Honors College);  GPA: 3.63}{May 2023}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Supercomputing Systems}
          {Learned about the hardware, software, and infrastructure that made up the Cori system at the National Energy Research Scientific Computing Center (NERSC). Cori is currently the 30th most powerful supercomputer in the world. Wrote code in C/C++ for multi-node compute jobs.}
        \resumeItem{Novel Technologies}
          {Installed the Flux framework (developed by Lawrence Livermore National Laboratory) onto NERSC's Cori system. Used software for containerization (Shifter), package management (Spack), scheduling and resource allocation (SLURM), multi-node job communication (PMIx), and command-line interface (Cray Linux).}
