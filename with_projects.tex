...
\resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Machine Learning}
          {Utilizing machine learning techniques and Python libraries such as OpenCV and TensorFlow to train networks that can analyze cell slide data.}
    ...
    \resumeSubheading
      {Lawrence Berkeley National Laboratory}{Berkeley, CA \textit{(remote)}}
      {High-Performance Computing Intern}{June 2021 -- Aug. 2021}
      \resumeItemListStart
        \resumeItem{Supercomputing Systems}
          {Learned about the hardware, software, and infrastructure that made up the Cori system at the National Energy Research Scientific Computing Center (NERSC). Cori is currently the 30th most powerful supercomputer in the world (per Top500).}
        \resumeItem{Novel Technologies}
         ...
         \resumeItem{Workflow Management}
          {Reviewed existing tools for automated management of scientific workflows to determine future workflow needs of NERSC users. Expanded workflow toolkit to include the Flux framework, a novel resource management framework with interactive job submission capabilities.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Engineering Subject Research}
          {Consulted on acoustic emission data collected from concrete degradation. Used Python and R to prepare/analyze data on concrete and other structures.}
...
\section{Current Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Internship Tracking App}
      {Java app designed for a university to store employer and student accounts, manage applications and job listings. Project for Software Engineering (CSE 247) class.}
...
\section{Campus Activities}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Chair, Association for Computing Machinery Student Chapter}
      {Coordinate student speakers, budgeting, donor relations, and biannual Code-A-Thon, a University-wide student-led coding competition.}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages}{Python, C++, Java, MATLAB}
    \resumeSubItem{Technologies}{Docker/Shifter, Git, Bash/Zsh (Linux Environment), PyPlot, Pandas, Microsoft Office Suite, \LaTeX}
  \resumeSubHeadingListEnd
